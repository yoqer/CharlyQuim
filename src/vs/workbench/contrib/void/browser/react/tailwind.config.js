...
module.exports = {
	...
	theme: {
		extend: {
			...
			// Cursor-style typography - slightly larger, better readability
			fontSize: {
				xs: '11px',
				sm: '12px',
				root: '13px',
			...
			// Cursor-style border radius
			borderRadius: {
				'none': '0',
				'sm': 'var(--void-radius-sm)',
				DEFAULT: 'var(--void-radius)',
				'lg': 'var(--void-radius-lg)',
				'full': '9999px',
			},
			// Cursor-style shadows
			boxShadow: {
				'sm': 'var(--void-shadow-sm)',
				DEFAULT: 'var(--void-shadow)',
