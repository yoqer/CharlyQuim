...
export class OrcideMainUpdateService extends Disposable implements IOrcideUpdateService {
	...
	async check(explicit: boolean): Promise<OrcideCheckUpdateResponse> {
	...
	private async _manualCheckGHTagIfDisabled(explicit: boolean): Promise<OrcideCheckUpdateResponse> {
		try {
